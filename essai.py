...
#                             style=ft.ButtonStyle(shape=ft.ContinuousRectangleBorder(radius=8)),
...
#                                style=ft.TextStyle(font_family="Poppins Medium", size=12, italic=True, color="#ebebeb"))
#         self.add = ft.IconButton(icon_color="black", icon=ft.icons.ADD_OUTLINED, tooltip="Créer devis",
#                                  on_click=self.open_new_devis_window
#                                  )
#         self.edit = ft.IconButton(icon_color="black", icon=ft.icons.EDIT_OUTLINED, tooltip="Modifier devis",
#                                   on_click=self.open_edit_devis_window
#                                   )
#         self.fp = ft.FilePicker(on_result=self.imprimer_bordereau)
#         self.delivery = ft.IconButton(icon_color="black", icon=ft.icons.PRINT_OUTLINED, tooltip="imprimer bordereau livraison",
#                                       on_click=lambda e: self.fp.save_file(allowed_extensions=["pdf"]))
#         self.bill = ft.IconButton(icon_color="black", icon=ft.icons.EURO_OUTLINED, tooltip="facturer", on_click=self.facturer_devis)
#         self.delete = ft.IconButton(icon_color="black", icon=ft.icons.DELETE_OUTLINED, tooltip="supprimer devis",
...
#         self.fp3 = ft.FilePicker(on_result=self.imprimer_devis_sans_IR)
...
#         )
#         self.ir_inactive = ft.Checkbox(
#             label="Désactiver IR", label_style=ft.TextStyle(font_family="Poppins Medium", size=12),
#             label_position="left"
#         )
...
#                 controls=[self.print_button, self.fp2, ft.Text("Desactiver IR", size=14, font_family="Poppins Regular"), self.ir_inactive]
#             )
#         )
...
#         self.up = ft.IconButton(icon_color="black", icon=ft.icons.ADD_CIRCLE_OUTLINE, icon_size=24, on_click=self.add_remise)
#         self.down = ft.IconButton(icon_color="black", icon=ft.icons.REMOVE_CIRCLE_OUTLINE, icon_size=24, on_click=self.remove_remise)
...
#         self.show_list_ref = ft.IconButton(icon_color="black", icon=ft.icons.IMAGE_SEARCH_OUTLINED, tooltip="rechercher", on_click=self.open_select_n_ref_windows)
...
#             title=ft.Text("Erreur"),
#             content=ft.Text("Veuillez choisir un devis",
...
#         self.show_list_m_ref = ft.IconButton(icon_color="black", icon=ft.icons.IMAGE_SEARCH_OUTLINED, tooltip="rechercher", on_click=self.open_select_m_ref_windows)
...
#                                     ft.Row(
#                                         [
#                                             ft.IconButton(icon_color="black", icon=ft.icons.REMOVE_CIRCLE_OUTLINE, icon_size=24,
#                                                           on_click=self.edit_remise_down),
#                                             self.m_remise,
#                                             ft.IconButton(icon_color="black", icon=ft.icons.ADD_CIRCLE_OUTLINE, icon_size=24,
...
#                         nb_pages = 1
#                     else:
#                         if (len(ref_list) / 20) % 2 == 0:
#                             nb_pages = (len(ref_list) / 20)
#                         else:
#                             nb_pages = (len(ref_list) // 20) + 1
#
#                 elif len(nb_list) == 1:
#                     pass
#                 elif len(nb_list) == 2:
...
#
#                 debut = 0
#                 fin = 20 if nb_pages > 1 else len(ref_list)
#
#                 # Si le nombre de pages du devis est égal à 1
#                 if nb_pages == 1:
#                     def draw_headers():
...
#                         can.drawCentredString(5.5*cm, 24.8*cm, f"N°: {self.search_devis.value}")
...
#                     can.setFont("Poppins Italic", 11)
#                     can.drawRightString(4*cm, (y-1.5)*cm, "Montant total:")
#                     can.setFont("Poppins Medium", 10)
#                     can.setFillColorRGB(0, 0, 0)
#                     can.drawString(4.3*cm, (y-1.5)*cm, f"{milSep(total_devis)}")
#
#                     # Remise
#                     if remm == 0:
#                         remise = "---"
...
#                     else:
#                         aff_rem = f"{remm}%"
#                         remise = int(total_devis * remm / 100)
#
#                     can.setFont("Poppins Italic", 10)
#                     can.setFillColorRGB(0.3, 0.3, 0.3)
#                     can.drawRightString(10.5*cm, (y-1.5)*cm, f"Remise ({aff_rem}):")
#                     can.setFont("Poppins Medium", 10)
#                     can.setFillColorRGB(0, 0, 0)
#                     can.drawString(10.8*cm, (y-1.5)*cm, f"{milSep(remise)}")
#
#                     # Montant après remise
#                     can.setFont("Poppins Italic", 10)
#                     can.setFillColorRGB(0.3, 0.3, 0.3)
#                     can.drawRightString(16.5*cm, (y-1.5)*cm, f"Total:")
#                     can.setFont("Poppins Medium", 10)
#                     mt_ap_remise = int(total_devis - remise) if remm > 0 else total_devis
#                     can.setFillColorRGB(0, 0, 0)
#                     can.drawString(16.8*cm, (y-1.5)*cm, f"{milSep(mt_ap_remise)}")
#
#                     # TVA
#                     can.setFont("Poppins Italic", 10)
#                     can.setFillColorRGB(0.3, 0.3, 0.3)
#                     can.drawRightString(4*cm, (y-2.2)*cm, "TVA (19,25%):")
#                     can.setFont("Poppins Medium", 10)
#                     can.setFillColorRGB(0, 0, 0)
#                     tva = int(mt_ap_remise * 19.25 // 100)
#                     can.drawString(4.3*cm, (y-2.2)*cm, f"{milSep(tva)}")
#
#                     # TTC
#                     can.setFont("Poppins Italic", 10)
#                     can.setFillColorRGB(0.3, 0.3, 0.3)
#                     can.drawRightString(10.5* cm, (y-2.2) * cm, "total TTC:")
#                     can.setFont("Poppins Medium", 10)
#                     can.setFillColorRGB(1, 0, 0)
#                     ttc = int(total_devis + tva)
#                     can.drawString(10.8*cm, (y-2.2) * cm, f"{milSep(ttc)}")
#
#                     can.setStrokeColorRGB(0.5, 0.5, 0.5)
#                     can.line(1*cm, (y-2.7)*cm, 20*cm, (y-2.7)*cm)
#
#                     # Montant en lettres
#                     can.setFont("Poppins Italic", 9)
#                     can.setFillColorRGB(0.5, 0.5, 0.5)
#                     can.drawCentredString(10.5*cm, (y-3.4) * cm, "Facture PROFORMA arrêtée à la somme de :")
#                     can.setFont("Poppins SemiBold", 10)
#                     can.setFillColorRGB(0, 0, 0)
#                     can.drawCentredString(10.5*cm, (y-3.9) * cm, f"{ecrire_en_lettres(ttc)}")
#
#                     # infos = backend.show_info_devis(dev)
#
#                     can.setStrokeColorRGB(0.5, 0.5, 0.5)
#                     can.line(1*cm, (y-4.4)*cm, 20*cm, (y-4.4)*cm)
#
#                     # Creation des lignes pour le NB
#                     can.setFont("Poppins Bold", 11)
#                     can.drawString(1*cm, (y-4.9) * cm, "NB:")
#                     # nb_list = infos[7].split(";")
#
#                     if infos[7] is not None:
#                         for i in range(len(nb_list)):
#                             can.setFont("Poppins Medium", 10)
#                             can.drawString(1*cm, ((y-5.4) - i * 0.5) * cm, f"{nb_list[i].lower()}")
#
#                     y = y - 4.9 - len(nb_list) * 0.5
#
#                     can.setStrokeColorRGB(0.5, 0.5, 0.5)
#                     can.line(1*cm, (y-0.5)*cm, 20*cm, (y-0.5)*cm)
#
#                     if infos[8] is not None:
#                         can.setFont("Poppins Italic", 9)
#                         can.setFillColorRGB(0.5, 0.5, 0.5)
#                         can.drawString(1*cm, (y-1)*cm, "Délai de livraison :".upper())
#                         can.setFont("Poppins Medium", 10)
#                         can.setFillColorRGB(0, 0, 0)
#                         can.drawString(4.5*cm, (y-1)*cm, f"{infos[8]}".upper())
#
#                     if infos[9] is not None:
#                         can.setFont("Poppins Italic", 9)
#                         can.setFillColorRGB(0.5, 0.5, 0.5)
#                         can.drawString(10*cm, (y-1)*cm, "Point de livraison : ".upper())
#                         can.setFont("Poppins Medium", 10)
#                         can.setFillColorRGB(0, 0, 0)
#                         can.drawString(13.5*cm, (y-1)*cm, f"{infos[9]}".upper())
#
#                     if infos[11] is not None:
#                         can.setFont("Poppins Italic", 9)
#                         can.setFillColorRGB(0.5, 0.5, 0.5)
#                         can.drawString(1*cm, (y-1.5) * cm, "Paiement :".upper())
#                         can.setFont("Poppins Medium", 10)
#                         can.setFillColorRGB(0, 0, 0)
#                         can.drawString(3.1*cm, (y-1.5)*cm, f"{infos[11]} jours après dépôt de facture".upper())
#
#                     if infos[10] is not None:
#                         can.setFont("Poppins Italic", 9)
#                         can.setFillColorRGB(0.5, 0.5, 0.5)
#                         can.drawString(10*cm, (y-1.5) * cm, "Validité de l'offre :".upper())
#                         can.setFont("Poppins Medium", 10)
#                         can.setFillColorRGB(0, 0, 0)
#                         can.drawString(13.5*cm, (y-1.5)*cm, f"{infos[10]} mois".upper())
#
#                     can.setStrokeColorRGB(0.5, 0.5, 0.5)
#                     can.line(1*cm, (y-2)*cm, 20*cm, (y-2)*cm)
#
#                     can.setFont("Poppins Italic", 9)
#                     can.setFillColorRGB(0.5, 0.5, 0.5)
#                     can.drawString(1*cm, (y-2.5) * cm, "INFORMATION BANCAIRES")
#
#                     can.setFont("Poppins Medium", 9)
#                     can.setFillColorRGB(0, 0, 0)
#                     can.drawString(1*cm, (y-3) * cm, f"par virement à:   {ENTITE_BANQUE},   IBAN {ENTITE_IBAN}".upper())
#                     can.drawString(1*cm, (y-3.5) * cm, f"Code swift:    {ENTITE_SWIFT},  Titualire: {ENTITE_NOM}".upper())
#
#                     can.save()
#
#                 # Si le nombre de pages du devis est > 1
#                 else:
#                     item = 1
#                     for i in range(0, nb_pages):
#
#                         # Si l'indice de la page est inférieur au nombre de pages - 1
#                         if i < nb_pages - 1:
#                             # dessin des entêtes
#                             def draw_headers():
#                                 entete = "assets/header.png"
...
#                                 can.drawImage(signature, 12*cm, 2*cm)
#                                 # infos de l'entreprise
#                                 can.setFont("Poppins Bold", 24)
#                                 can.setFillColorRGB(0, 0, 0)
#                                 can.drawCentredString(5.5 * cm, 24.5 * cm, "PROFORMA")
#                                 can.setFont("Poppins Medium", 13)
...
#                             can.showPage()
#
#                         # Si l'indice de la page est égal au nombre de pages - 1
#                         else:
#                             # dessin des entêtes
#                             def draw_headers():
#                                 entete = "assets/header.png"
...
#
#                             # pour chaque nombre compris entre début et fin on imprime les données
#                             for number in range(debut, fin):
#                                 total_devis += ref_list[number][4]
#                                 can.setFillColorRGB(0, 0, 0)
#                                 can.setFont("Poppins Medium", 10)
...
#                                 nb_list = infos[7].split(";")
#                                 if infos[7] is not None:
#                                     for indice in range(0, len(nb_list) - 1):
#                                         can.setFont("Poppins Bold", 12)
#                                         can.drawString(1*cm, ((y - 2.5) - i * 0.5) * cm, f"{nb_list[indice].lower()}")
#
...
#
#                     can.setFillColorRGB(0, 0, 0)
#                     can.setFont("Poppins SemiBold", 11)
#                     can.drawRightString(16.5 * cm, (y-1)*cm, "Montant total:")
#                     can.setFont("Poppins Medium", 11)
#                     can.drawString(17*cm, (y-1)*cm, f"{milSep(total_devis)}")
#
#                     # Si la remise est nulle
#                     if int(remm) == 0:
#                         # TVA
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawRightString(16.5 * cm, (y - 1.7) * cm, "TVA (19,25%):")
#                         can.setFont("Poppins Medium", 11)
#                         tva = int(total_devis * 19.25 // 100)
#                         can.drawString(17*cm, (y-1.7)*cm, f"{milSep(tva)}")
#
#                         # TTC
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawRightString(16.5 * cm, (y-2.4) * cm, "TTC:")
#                         can.setFont("Poppins Medium", 11)
#                         ttc = int(total_devis + tva)
#                         can.drawString(17*cm, (y-2.4) * cm, f"{milSep(ttc)}")
#
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawRightString(16.5 * cm, (y-3.1) * cm, "IR:")
#                         can.setFont("Poppins Medium", 11)
#                         ir = int(ttc * 2.2 / 100)
#                         can.drawString(17*cm, (y-3.1) * cm, f"{milSep(ir)}")
#
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawRightString(16.5 * cm, (y-3.8) * cm, "Net à payer:")
#                         can.setFont("Poppins Medium", 11)
#                         nap = ttc - ir
#                         can.drawString(17*cm, (y-3.8) * cm, f"{milSep(nap)}")
#
#                         # Montant en lettres
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawString(1*cm, (y-4.8) * cm, "Facture PROFORMA arrêtée à la somme de :")
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawString(1*cm, (y-5.3) * cm, f"{ecrire_en_lettres(nap)}")
#
#                         infos = backend.show_info_devis(dev)
#
#                         # Creation des lignes pour le NB
#                         can.setFont("Poppins Bold", 11)
#                         can.drawString(1*cm, (y-6.3) * cm, "NB:")
#                         nb_list = infos[7].split(";")
#                         if infos[7] is not None:
#                             for i in range(0, len(nb_list) - 1):
#                                 can.setFont("Poppins Medium", 11)
#                                 can.drawString(1*cm, ((y-5.8) - i * 0.5) * cm, f"{nb_list[i].lower()}")
#
#                         y = y - 6.3 - len(nb_list) * 0.5
#
#                         if infos[8] is not None:
#                             can.setFont("Poppins Bold", 11)
#                             can.drawString(1*cm, (y-1)*cm, f"Délai de livraison: ")
#                             can.setFont("Poppins Medium", 11)
#                             can.drawString(5*cm, (y-1)*cm, f"{infos[8]}")
#
#                         if infos[9] is not None:
#                             can.setFont("Poppins Bold", 11)
#                             can.drawString(1*cm, (y-1.5)*cm, "Point de livraison: ")
#                             can.setFont("Poppins Medium", 11)
#                             can.drawString(5*cm, (y-1.5)*cm, f"{infos[9]}")
#
#                         if infos[11] is not None:
#                             can.setFont("Poppins Bold", 11)
#                             can.drawString(1*cm, (y-2) * cm, f"Paiement: ")
#                             can.setFont("Poppins Medium", 11)
#                             can.drawString(3.5*cm, (y-2)*cm, f"{infos[11]} jours après dépôt de facture")
#
#                         if infos[10] is not None:
#                             can.setFont("Poppins Bold", 11)
#                             can.drawString(1*cm, (y-2.5) * cm, f"validité de l'offre: ")
#                             can.setFont("Poppins Medium", 11)
#                             can.drawString(5*cm, (y-2.5)*cm, f"{infos[10]} mois")
#
#                         can.setFont("Poppins SemiBold", 10)
#                         can.drawString(1*cm, (y-3.5) * cm, "INFORMATION BANCAIRES")
#                         can.setFont("Poppins Medium", 10)
#                         can.drawString(1*cm, (y-4) * cm, f"par virement à: {ENTITE_BANQUE},   IBAN {ENTITE_IBAN}")
#                         can.drawString(1*cm, (y-4.5) * cm, f"Code swift: {ENTITE_SWIFT},  Titualire: {ENTITE_NOM}")
#
#                     # si la remise est non nulle
#                     else:
#                         # remise
...
#                         mt_rem = int(total_devis * rem // 100)
#                         can.setFont("Poppins Bold", 11)
#                         can.drawRightString(16.5*cm, (y-1.7)*cm, f"Remise {rem}%:")
#                         can.setFont("Poppins Medium", 11)
#                         can.drawString(17*cm, (y-1.7)*cm, f"{milSep(mt_rem)}")
#
#                         # Montant après remise
#                         mt_ap = total_devis - mt_rem
#                         can.setFont("Poppins Bold", 11)
#                         can.drawRightString(16.5*cm, (y-2.4)*cm, "Montant remisé")
#                         can.setFont("Poppins Medium", 11)
#                         can.drawString(17*cm, (y-2.4)*cm, f"{milSep(mt_ap)}")
#
#                         # TVA
#                         can.setFillColorRGB(0, 0, 0)
#                         can.setFont("Poppins Bold", 11)
#                         can.drawRightString(16.5*cm, (y-3.1)*cm, "TVA (19,25%):")
#                         can.setFont("Poppins Medium", 11)
#                         tva = int(mt_ap * 19.25 / 100)
#                         can.drawString(17*cm, (y-3.1)*cm, f"{milSep(tva)}")
#
#                         # TTC
#                         can.setFont("Poppins Bold", 11)
#                         can.drawRightString(16.5*cm, (y-3.8)*cm, "TTC:")
#                         can.setFont("Poppins Medium", 11)
#                         ttc = int(total_devis + tva)
#                         can.drawString(17*cm, (y-3.8)*cm, f"{milSep(ttc)}")
#
#                         # IR
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawRightString(16.5 * cm, (y-4.5) * cm, "IR:")
#                         can.setFont("Poppins Medium", 11)
#                         ir = int(ttc * 2.2 / 100)
#                         can.drawString(17*cm, (y-4.5) * cm, f"{milSep(ir)}")
#
#                         # NAP
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawRightString(16.5 * cm, (y-5.2) * cm, "Net à payer:")
#                         can.setFont("Poppins Medium", 11)
#                         nap = ttc - ir
#                         can.drawString(17*cm, (y-5.2) * cm, f"{milSep(nap)}")
#
#                         # Montant en lettres
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawString(1*cm, (y-6.2)*cm, "Facture arrêtée à la somme de:")
#                         can.setFont("Poppins SemiBold", 11)
#                         can.drawString(1*cm, (y-6.7)*cm, f"{ecrire_en_lettres(ttc)}")
#
#                         infos = backend.show_info_devis(dev)
#
#                         # Creation des lignes pour le NB
#                         can.setFont("Poppins Bold", 11)
#                         can.drawString(1*cm, (y-7.7) * cm, "NB:")
#                         nb_list = infos[7].split(";")
#                         if infos[7] is not None:
#                             for i in range(0, len(nb_list) - 1):
#                                 can.setFont("Poppins Medium", 11)
#                                 can.drawString(1*cm, ((y-7.2) - i * 0.5) * cm, f"{nb_list[i].lower()}")
#
#                         y = y - 7.7 - len(nb_list) * 0.5 if len(nb_list) > 0 else y-6.3
#
#                         if infos[8] is not None:
#                             can.setFont("Poppins Bold", 11)
#                             can.drawString(1*cm, (y-1)*cm, f"Délai de livraison: ")
...
#
#
#     def imprimer_devis_sans_IR(self, e: ft.FilePickerResultEvent):
...
#             can.drawCentredString(16.5 * cm, (y - 1) * cm, "Total:")
#             can.setFont("Poppins Medium", 11)
#             can.drawCentredString(18.75 * cm, (y - 1) * cm, f"{milSep(total_devis)} FCFA")
#
...
#
#                 can.setFont("Poppins Bold", 11)
#                 can.drawString(1*cm, (y-3) * cm, f"Montant total: {ecrire_en_lettres(montant_ap_remise)} FCFA")
#                 infos = backend.show_info_devis(self.search_devis.value)
#
#                 can.setFont("Poppins Medium", 11)
#                 can.drawString(1*cm, (y - 4) * cm, "NB:")
...
#                 can.line(2*cm, (y-2) * cm, 2*cm, (y-3) * cm)
#                 can.line(13.5*cm, (y-2) * cm, 13.5*cm, (y-3) * cm)
#                 can.line(14.5 * cm, (y-2) * cm, 14.5 * cm, (y-3) * cm)
#                 can.line(15.5 * cm, (y-2) * cm, 15.5 * cm, (y-3) * cm)
#                 can.line(17.5 * cm, (y-2) * cm, 17.5 * cm, (y-3) * cm)
...
#             can.setFillColorRGB(0, 0, 0)
#             can.setFont("Poppins Bold", 11)
#             can.drawRightString(16.5 * cm, (y - 1) * cm, "Total:")
#             can.setFont("Poppins Medium", 11)
#             can.drawCentredString(18.75 * cm, (y - 1) * cm, f"{milSep(total_devis)}")
#
#             can.setFont("Poppins Bold", 12)
