            ...
            if self.ir_inactive.value:
                ...
                if nb_pages == 1:
                    ...
                    if remm == 0:
                        ...
                        can.drawCentredString(10.5*cm, (y-3) * cm, "Facture PROFORMA arrêtée à la somme de :")
                        can.setFont("Poppins SemiBold", 10)
                        can.setFillColorRGB(0, 0, 0)
                        ...
                        can.drawString(1*cm, (y-4.5) * cm, "NB:")

                        nb_list = infos[7].split(";")
                        if infos[7] is not None:
                            for i in range(0, len(nb_list) - 1):
                                can.setFont("Poppins Bold", 12)
                                can.drawString(1*cm, ((y - 5) - i * 0.5) * cm, f"{nb_list[i].lower()}")

                        y = y - 4.5 - len(nb_list) * 0.5
                    ...
                    # Si la remise est non nulle
                        ...
                        can.setStrokeColorRGB(0.5, 0.5, 0.5)
                        can.line(1*cm, (y-5)*cm, 20*cm, (y-5)*cm)

                        # Creation des lignes pour le NB
                        can.setFont("Poppins Bold", 11)
                        can.drawString(1*cm, (y-5.5) * cm, "NB:")

                        infos = backend.show_info_devis(self.search_devis.value)

                        can.setFont("Poppins Medium", 11)
                        can.drawString(1*cm, (y - 6) * cm, "NB:")
                        nb_list = infos[7].split(";")
                        if infos[7] is not None:
                            for i in range(len(nb_list) - 1):
                                can.setFont("Poppins Bold", 12)
                                can.drawString(1*cm, ((y - 6.5) - i * 0.5) * cm, f"{nb_list[i].lower()}")

                        y = y - 6 - len(nb_list) * 0.5
                ...
                if nb_pages == 1:
                    ...
                    if remm == 0:
                        ...
                        if infos[7] is not None:
                            for i in range(0, len(nb_list) - 1):
                                can.setFont("Poppins Bold", 12)
                                can.drawString(1*cm, ((y - 6) - i * 0.5) * cm, f"{nb_list[i].lower()}")

                        y = y - 5.5 - len(nb_list) * 0.5
                    ...
                    # Si la remise est non nulle
                        ...
                        # Creation des lignes pour le NB
                        can.setFont("Poppins Bold", 11)
                        can.drawString(1*cm, (y-6.5) * cm, "NB:")

                        infos = backend.show_info_devis(self.search_devis.value)

                        can.setFont("Poppins Medium", 11)
                        can.drawString(1*cm, (y-7) * cm, "NB:")
                        nb_list = infos[7].split(";")
                        if infos[7] is not None:
                            for i in range(len(nb_list) - 1):
                                can.setFont("Poppins Bold", 12)
                                can.drawString(1*cm, ((y - 7.5) - i * 0.5) * cm, f"{nb_list[i].lower()}")

                        y = y - 7 - len(nb_list) * 0.5
